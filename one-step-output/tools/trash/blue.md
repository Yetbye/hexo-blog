...
category: blue
---
<!-- ============ Blue · 水彩国风画墙（Venus × paper-reading-blog DNA） ============ -->
<div class="gw-wrap" style="--acc:#4A7DBF;--acc2:#7FA8C4">
  <div class="gw-blob gw-blob-a" aria-hidden="true"></div>
  <div class="gw-blob gw-blob-b" aria-hidden="true"></div>

  <header class="gw-hero">
    <span class="gw-seal">青</span>
    <div class="gw-head-text">
      <span class="gw-eyebrow">GALLERY · BLUE</span>
      <h1 class="gw-title">Blue</h1>
      <p class="gw-hand">海与远方的蓝</p>
    </div>
  ...
  <section class="gw-grid">
      <figure class="gw-card" data-idx="0">
        <img src="/image/gallery/blue/1.jpg" alt="Blue 1" loading="lazy">
        <figcaption>青 · 其一</figcaption>
      </figure>

      <figure class="gw-card" data-idx="1">
        <img src="/image/gallery/blue/2.jpg" alt="Blue 2" loading="lazy">
        <figcaption>青 · 其二</figcaption>
      </figure>

      <figure class="gw-card" data-idx="2">
        <img src="/image/gallery/blue/3.jpg" alt="Blue 3" loading="lazy">
        <figcaption>青 · 其三</figcaption>
      </figure>
  </section>
...
(function(){
  'use strict';
  var SLIDES = ["/image/gallery/blue/1.jpg","/image/gallery/blue/2.jpg","/image/gallery/blue/3.jpg"];
