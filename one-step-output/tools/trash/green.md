...
category: green
---
<!-- ============ Green · 水彩国风画墙（Venus × paper-reading-blog DNA） ============ -->
<div class="gw-wrap" style="--acc:#5A7B6B;--acc2:#8FA68E">
  <div class="gw-blob gw-blob-a" aria-hidden="true"></div>
  <div class="gw-blob gw-blob-b" aria-hidden="true"></div>

  <header class="gw-hero">
    <span class="gw-seal">苍</span>
    <div class="gw-head-text">
      <span class="gw-eyebrow">GALLERY · GREEN</span>
      <h1 class="gw-title">Green</h1>
      <p class="gw-hand">草木生长的绿</p>
    </div>
  ...
  <section class="gw-grid">
      <figure class="gw-card" data-idx="0">
        <img src="/image/gallery/green/1.png" alt="Green 1" loading="lazy">
        <figcaption>苍 · 其一</figcaption>
      </figure>

      <figure class="gw-card" data-idx="1">
        <img src="/image/gallery/green/2.jpg" alt="Green 2" loading="lazy">
        <figcaption>苍 · 其二</figcaption>
      </figure>

      <figure class="gw-card" data-idx="2">
        <img src="/image/gallery/green/3.jpg" alt="Green 3" loading="lazy">
        <figcaption>苍 · 其三</figcaption>
      </figure>

      <figure class="gw-card" data-idx="3">
        <img src="/image/gallery/green/4.jpg" alt="Green 4" loading="lazy">
        <figcaption>苍 · 其四</figcaption>
      </figure>
  </section>
...
(function(){
  'use strict';
  var SLIDES = ["/image/gallery/green/1.png","/image/gallery/green/2.jpg","/image/gallery/green/3.jpg","/image/gallery/green/4.jpg"];
